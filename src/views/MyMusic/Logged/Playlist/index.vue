            ...
            <ul v-for="(song, index) in songdetail" :key="index">
              <li class="m1 over underline">
                ...
                <i
                  ...
                  :class="{ active: song.id == musicNow.id }"
                ></i>
              </li>
      ...
      <div class="comment" v-show="id != undefined">
        ...
        <div class="mainer">
          ...
          <div class="flag">
            <div class="head">
              <img
                src="https://p3.music.126.net/dwslx7VNYE-h8TP0VkBxcg==/109951165800028895.jpg?param=50y50"
              />
            </div>
            <div class="txt">
              <textarea
              ...
              <div class="cntwrap">
                <div class="cnt">
                  ...
                  <div class="que" v-show="com.beReplied[0]">
                    <a class="fc" v-if="com.beReplied[0]">{{
                      com.beReplied[0].user.nickname
                    }}</a>
                    <span v-if="com.beReplied[0]"
                      >：{{ com.beReplied[0].content }}</span
                    >
                  </div>
                </div>
                <div class="rp">
...
export default {
  ...
  methods: {
    // 获取歌单详情
    async getPlayList() {
      let result = await this.$API.reqPlayListDetail(
        this.id,
    ...
    //获取评论
    async getComment() {
      let result = await this.$API.reqCommentPlayList(
        this.id,
        this.searchParams.pageSize,
        (this.searchParams.pageNo - 1) * this.searchParams.pageSize
      );
